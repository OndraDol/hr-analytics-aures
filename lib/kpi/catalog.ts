...
export const KPI_CATALOG = [
  {
    code: 'HR_STATS',
    nameCs: 'HR statistiky',
    section: 'I',
    priority: 1,
    recipient: 'B0-B3',
    source: 'HRIS',
    definitionCs: 'Počet aktivních zaměstnanců, FTE, demografie, DEI a rozdíly v odměňování.',
    formulaCs: 'Aktivní zaměstnanci k poslednímu dni období.',
    frequency: 'yearly',
    owner: 'HR reporting',
    riskAnalysisCs: 'Nejasný stav populace zkresluje všechny navazující HR metriky.',
    businessImpactCs: 'Základ pro plánování kapacit, nákladů a ESG reporting.',
    direction: 'target',
    trendType: 'YoY',
    unit: 'count',
    thresholds: { target: 1_735, green: 1_735, amber: 1_735, red: 1_735, targetToleranceGreen: 0.15, targetToleranceAmber: 0.3 },
    actionIfOffTrackCs: 'Zkontrolovat rozdíl proti staffplanu a vysvětlit odchylku po divizích.',
