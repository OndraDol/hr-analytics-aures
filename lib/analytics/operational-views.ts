...
export const OPERATIONAL_VIEWS: readonly OperationalViewDefinition[] = [
  ...
  },
  {
    ...
    title: 'eNPS latest',
    shortTitle: 'eNPS latest',
    eyebrow: 'Operativa M7',
    description: 'Poslední eNPS vlna, participace, mix odpovědí a segmenty pro follow-up.',
    accent: '#0ea5e9',
    icon: SmilePlus,
  },
  {
...
async function buildEsg(
  ...
  const datapoints: DetailTableRow[] = [
    ...
    { label: 'Věková struktura zaměstnanců', value: formatNumber(avgAge, 1), secondary: 'ready', dataQuality: 'ready', detail: 'průměrný věk, detailní histogram v HR statistice' },
