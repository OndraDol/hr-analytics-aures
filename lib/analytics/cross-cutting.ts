...
export const ANALYTICS_TOPICS: readonly AnalyticsTopicDefinition[] = [
  {
    ...
    title: 'Detail odchodů',
    shortTitle: 'Odchody',
    eyebrow: 'Detailní pohled',
    description: 'Analýza odchodů podle délky působení, klíčových rolí, divizí, eNPS a mzdového kontextu.',
    accent: '#e11d48',
    icon: HeartPulse,
  },
  {
    ...
    shortTitle: 'Náborový průchod',
    eyebrow: 'Detailní pohled',
    description: 'Průchod kandidátů náborem, úzká místa, zdroje kandidátů, náklady a klíčové pozice.',
    accent: '#0ea5e9',
  ...
  },
  {
    ...
    title: 'Odměňování a rozdíly',
    shortTitle: 'Odměňování',
    eyebrow: 'Detailní pohled',
    description: 'Mzdová distribuce po úrovních rolí, celkový a očištěný rozdíl v odměnách, délka působení a odlehlé hodnoty.',
    accent: '#f97316',
